...
//        processRequest(request, response);
        ...
        String uno[] = request.getParameterValues("cursos");
        String ss = "";
        for (String d : uno) {
            ss = ss + d+ ",";
        }

        System.out.println("curso: " + ss);

        Aspirante obj = new Aspirante(nombre, correo, telefono, ss, new Date());
        Aspirante.listaA.add(obj);
